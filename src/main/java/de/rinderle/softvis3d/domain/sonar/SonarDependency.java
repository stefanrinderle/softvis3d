...
public class SonarDependency {
	...
	public String toString() {
		return "SonarDependency{" + "id=" + this.id + ", fromSnapshotId="
				+ this.fromSnapshotId + ", fromResourceId="
				+ this.fromResourceId + ", toSnapshotId=" + this.toSnapshotId
				+ ", toResourceId=" + this.toResourceId + ", usage='"
				+ this.usage + '\'' + ", weight=" + this.weight
				+ ", fromScope='" + this.fromScope + '\'' + ", toScope='"
				+ this.toScope + '\'' + '}';
	}
