	...
	Cloneable, ImageObserver, Shape, IGrappaObjectListener
{
     ...
     *
     * @see att.grappa.Grappa#shapeBoundText
     */
     ...
     *
     * @see att.grappa.Grappa#shapeClearText
     */
     ...
     *
     * @see att.grappa.Grappa#shapeDrawText
     */
    ...
    public void updateShape() {
    	...
    	case SUBGRAPH:
    		...
    		if(minSize != null) {
    			if(sgbox == null) {
    				sgbox = new Rectangle2D.Double(0,0,minSize.getWidth(),minSize.getHeight());
    			} else {
    				sgbox.add(new Rectangle2D.Double(sgbox.getCenterX()-(minSize.getWidth()/2.0),sgbox.getCenterY()-(minSize.getHeight()/2.0),minSize.getWidth(),minSize.getHeight()));
    			}
    		}
    		...
    		if(minBox != null) {
    			if(sgbox == null) {
    				...
    				sgbox.add(new Rectangle2D.Double(minBox.x,minBox.y,minBox.width,minBox.height));
    			}
    		}
    		if(sgbox == null) {
    			sgbox = new Rectangle2D.Double(0,0,0,0);
    		}
    		shape = sgbox;
    		break;
    	default:
     ...
     *
     * @see getPathIterator( java.awt.geom.AffineTransform)
     */
