...
public class GrappaPanel extends javax.swing.JPanel
    implements GrappaConstants, ComponentListener,
...
//			EventQueue.invokeLater(this);
    ...
    private Point2D componentPaint(Graphics g) {
    	...
    	if(scaleToFit || scaleToSize != null) {
    		...
    		if(scaleToFit) {
    			...
    			while (tprnt != null && !(tprnt instanceof JViewport))
    		...
    		if(scaleChanged) {
    			...
    			if (tprnt != null)
    				prnt = tprnt;
    			if(prnt instanceof JViewport && inverseTransform != null) {
     ...
     *
     * @see att.grappa.Graph#setToolTipText(String)
     */
     ...
     *
     * @see att.grappa.GrappaPanel#setToolTipText(String)
     */
