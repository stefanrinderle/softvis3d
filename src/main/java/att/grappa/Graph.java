...
public class Graph extends Subgraph
{
     ...
     *
     * @param graphName the name of this graph.
     * @see att.grappa.Graph#Graph(String, boolean, boolean)
     */
     ...
     * @see att.grappa.Graph#dropcloth(boolean, boolean)
     */
     ...
     * @see att.grappa.Graph#setSynchronizePaint(boolean)
     */
     ...
     * @see att.grappa.GrappaConstants#PKG_LOWER
     */
     ...
     * @see att.grappa.GrappaConstants#NODE
     * @see att.grappa.GrappaConstants#EDGE
     * @see att.grappa.GrappaConstants#SUBGRAPH
     */
     ...
     *
     * @see att.grappa.Graph#INDENT_STRING
     */
     ...
     * @see att.grappa.Graph#isEditable()
     */
     ...
     * @return previous value
     * @see att.grappa.Graph#isSelectable()
     */
     ...
     * @return previous value
     * @see att.grappa.Graph#isMenuable()
     */
     ...
     * @see att.grappa.Graph#setErrorWriter(java.io.PrintWriter)
     */
