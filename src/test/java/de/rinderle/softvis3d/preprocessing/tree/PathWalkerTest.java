...
public class PathWalkerTest {
    ...
    public void testAddPathSimple() {
        ...
        assertEquals("kjsdfksjdbf.java has no children", 0,
                tree.getChildren().get("src").getChildren().get("kjsdfksjdbf.java").getChildren().size());
    ...
    public void testAddPathLongStartPath() {
        ...
        assertNotEquals(Integer.valueOf(413), tree.getChildren().get("src").getChildren().get("main").getChildren()
                .get("java").getId());
        assertNotEquals(Integer.valueOf(413), tree.getChildren().get("src").getChildren().get("main").getChildren()
                .get("java").getChildren().get("de").getChildren().get("rinderle").getId());
        assertEquals(
                Integer.valueOf(413),
                tree.getChildren().get("src").getChildren().get("main").getChildren().get("java").getChildren()
                        .get("de").getChildren().get("rinderle").getChildren().get("softVis3D").getId());
    }
    ...
    public void testAddPathShortStartPath() {
        ...
        final TreeNode sixth =
                tree.getChildren().get("src").getChildren().get("testForSoftVis").getChildren().get("xx").getChildren()
    ...
    private void callWalkerWithMetrics(final PathWalker walker, final int id, final String path) {
        SonarSnapshotBuilder builder = new SonarSnapshotBuilder(id).withPath(path);
