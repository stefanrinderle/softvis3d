...
const leakPeriod: Profile = new ProfileBuilder("leakPeriod", "Leak period")
    .withConfiguration(Metric.complexityMetric, Metric.newLinesOfCodeMetric, Scales.availableScales[0])
...
const duplicatedLinesOfCode: Profile = new ProfileBuilder("duplicatedLinesOfCode", "Duplicated lines")
    .withConfiguration(Metric.complexityMetric, Metric.duplicatedLinesOfCodeMetric, Scales.availableScales[0])
...
const custom: Profile = new ProfileBuilder("custom", "Customize")
    .withConfiguration(Metric.noMetric, Metric.noMetric, Scales.availableScales[0])
