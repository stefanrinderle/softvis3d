...
ThreeViewer.FileLoaderDirective = function () {
  return {
    restrict: 'A',
    templateUrl: RESOURCES_BASE_PATH + './static/threeViewer/partials/file-loader.html'
  };
};
...
ThreeViewer.ToolbarDirective = function () {
  return {
    restrict: 'A',
    templateUrl: RESOURCES_BASE_PATH + './static/threeViewer/partials/toolbar.html'
  };
};
...
ThreeViewer.HelpDirective = function () {
  return {
    restrict: 'A',
    templateUrl: RESOURCES_BASE_PATH + './static/threeViewer/partials/help.html'
  };
};
